...
ОТВЕТ (документ с ошибками OCR):
{extracted_text[:600]}

Исправь ошибки OCR. Найди 1-3 строки таблицы где этот текст подходит как ответ. Верни JSON:
{{"matched_rows":[номера строк],"target_column":"Свидетельства","extracted_data":"текст с исправленными ошибками OCR","explanation":"причина"}}
