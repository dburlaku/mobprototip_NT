...
Найди 1-3 строки таблицы где текст является ответом. Исправь ошибки OCR. Верни JSON:
{{"matched_rows":[номера],"target_column":"Свидетельства","extracted_data":"<сюда вставь исправленный текст>","explanation":"<причина>"}}
